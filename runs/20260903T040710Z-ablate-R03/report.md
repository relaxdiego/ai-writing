...
| S6 | em-dash | per 1k words | 9.69 | 0.59 | ↓ -9.10 | **yes** (±1.16) |
...
| S6 | em-dash | per 1k words | 9.13 | 1.24 | ↓ -7.89 | **yes** (±0.83) |
...
| K5 | em-dash interruption | per 1k words | 1.58 | 0.21 | ↓ -1.38 | **yes** (±0.70) |
| | **context** | | | | | |
